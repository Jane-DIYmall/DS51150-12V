...
> ![](../vx_images//232963823250084.png =300x)
...
>3. 对Servo.h库文件进行如下修改
![](../vx_images/172790200237358.png =800x)
```c
...
![](../vx_images/254111500260283.png  =800x)

## 3.2 DS51150-12V 270° 同Arduino接线说明

![](../vx_images/583221600257887.png  =800x)
...
![](../vx_images/120364400255389.png =800x)
